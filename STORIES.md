...
| [05-01-clean-copy-selection](docs/stories/05-01-clean-copy-selection.md) | Copy ohne Zeitstempel/IP (`user-select: none`) | Geplant | `feature/05-01-clean-copy-selection` | REQ-014 → §4a |
