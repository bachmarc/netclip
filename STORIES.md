...
| [09-02-clear-version-sync](docs/stories/09-02-clear-version-sync.md) | Clear-Sync: Version statt consume-once | Erledigt (QA-PASS, Loop 1; User-Go) | `feature/09-02-clear-version-sync` | REQ-019 → §4, §4a |
